...
\begin{SourceCode}{Intput}{TeX}
  \[
    ...
    -
    \undernote*{%
      x^5 + \int_{c}^{\frac{d}{e}}\sum_{k=1}^{n} {}_n\mathrm{C}_k x^k
...
\begin{itemize}
  ...
  \item \textbf{v2.0.0 (2026/02/06)} --- In this update, I made changes in the following two points:
    \begin{itemize}
